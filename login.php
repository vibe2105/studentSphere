...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!empty ($username) && !empty ($password)) {
        ...
        $query = "SELECT * FROM user WHERE uname = ? AND pass = ? LIMIT 1";
        ...
        if ($result && $result->num_rows > 0) {
            ...
            $_SESSION['num'] = $user_data['num'];
            $_SESSION['club'] = $user_data['club'];
            ...
            <div class="form-box login">
                <form method="POST">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="uname" class="matrixID" required>
                    ...
                    <div class="create-account">
                        ...
                        <p>Login as ADMIN? <a href="loginAdmin.php">Sign In</a></p>
                    </div>
                </form>
            </div>
        </div>
